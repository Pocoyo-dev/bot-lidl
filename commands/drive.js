...
module.exports.run = async (client, msg, args) => {
  ...
  let itemVerification = itemList.argItem;
  ...
  if (itemVerification === "true") {
    ...
    const options = {
      headers: {},
      body: `value1=${args[0]}&value2=${args[1]}&value3=${args[2]}`,
    };
    ...
    const confirmationEmbed = new Discord.MessageEmbed()
      .setColor("#0099ff")
      .setTitle("Votre commande est passée ! Allez voir vos MP pour confirmer celle-ci !");
    ...
    const confirmationEmbedDM = new Discord.MessageEmbed()
      ...
      .addFields(
        {name : "Lien de confimation" , value : `[Lien de confirmation](https://docs.google.com/forms/d/e/1FAIpQLSePBqQqwbD42wd6A41ATDzKaxFfeTRWuHgkgWL3AvJkqmcP2Q/formResponse?usp=pp_url&entry.1818559927=${args[0]}&entry.86871255=${args[1]}&entry.46215118=${args[2]}&entry.740390018=${discordUser}&submit=Submit)`}
      )
    msg.author.send("")
  }
};
